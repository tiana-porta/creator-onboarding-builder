  ...
  return (
    <div className="min-h-screen bg-dark relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        >
          Where the future of <span className="text-accent font-medium">internet business</span> begins
        </motion.p>
        ...
        >
          <motion.div
            className="h-px bg-gradient-to-r from-transparent via-accent to-transparent w-32"
            initial={{ width: 0 }}
            animate={{ width: 128 }}
      ...
      <div className="absolute top-0 right-0 w-32 h-32 border-t-2 border-r-2 border-accent/30" />
      <div className="absolute bottom-0 left-0 w-32 h-32 border-b-2 border-l-2 border-accent/30" />
