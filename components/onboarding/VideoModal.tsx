          ...
          >
            <div className="bg-dark border-2 border-primary/20 rounded-3xl p-6 max-w-4xl w-full shadow-2xl">
                ...
                {videoUrl ? (
                    ...
                    <div className="space-y-4 max-w-2xl mx-auto">
                      {instructionalContent.steps.map((step, index) => (
                        <div key={index} className="flex items-start gap-4 bg-primary/5 rounded-lg p-4">
                          <div className="flex-shrink-0 w-8 h-8 rounded-full bg-accent text-white font-bold flex items-center justify-center text-sm">
                            {step.step}
                          </div>
                    ...
                    {!hasBeenWatched && (
                      <div className="text-center mt-6">
                        <button
                          ...
                          className="px-6 py-2 bg-accent text-white rounded-lg hover:bg-accent/90 transition-all font-medium"
                        >
                          I Understand
                        </button>
                      </div>
                  ...
                  <div className="aspect-video flex items-center justify-center bg-gradient-to-br from-primary/10 to-primary/5">
                    <div className="text-center">
                      ...
                      <p className="text-primary/60 font-medium mb-4">Video will play here</p>
                      <p className="text-xs text-primary/40 mb-4">Video embed placeholder</p>
                      {!hasBeenWatched && (
                        <button
                          onClick={() => {
                            if (onMarkWatched) {
                      ...
                      {hasBeenWatched && (
                        <div className="text-accent font-bold">✓ Watched</div>
                      )}
                    </div>
                  </div>
                )}
              ...
              <p className="text-sm text-primary/60 mt-4 text-center">
                {hasBeenWatched ? (
                  <span className="text-accent font-medium">✓ Video watched</span>
                ) : videoUrl ? (
